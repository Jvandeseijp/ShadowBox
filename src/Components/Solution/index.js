...
import { ReactComponent as HeaderBottom } from "../../Assets/HeaderBottom.svg";
import SolutionImg from "../../Assets/SolutionImg.png";
import "./index.css";

const Solution = () => {
  return (
    <div className="solutionCon">
      <span className="headingTopic">THE SOLUTION</span>
        <HeaderBottom style={{ stroke: "black", fill: "white", width: '13%' }} />
      <span className="heading">AN EQUAL DOLLAR</span>
      <span className="subHead">
        MULTI-MEDIA PRESENTATION IS CURRENTLY UPDATING. THANK YOU
      </span>
      ...
      <HeaderBottom style={{ stroke: "white", fill: "black", width: '13%' }} />
    </div>
  );
};
